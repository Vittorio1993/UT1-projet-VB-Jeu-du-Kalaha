Public Class Jeu_du_kalaha_Contre_ordinateur_facile
    ...
    Public Sub ordinateur()
        'L’ordinateur choisit aléatoirement de cliquer sur un bouton sauf quand la valeur est égale 0.
        Dim repondre As Integer
        If JeuTermine(a) Then
            afficher_button()
            If a(6) < a(13) Then
    ...
    Private Sub Jeu_du_kalaha_Contre_ordinateur_facile_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
